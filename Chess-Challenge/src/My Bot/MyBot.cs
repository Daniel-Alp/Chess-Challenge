...
public class MyBot : IChessBot
{
    ...
    Move[,] killerMoves = new Move[51, 2];
    ...
    int Search(int alpha, int beta, int depth, int ply, bool allowNull)
    {
        ...
        int bestEval = -10000000, eval = Evaluate(), initAlpha = alpha;
        ...
        {
            move = moves[i];
            if (move == transposition.bestMove) evalGuess[i] += 10000000;
    ...
    int Evaluate()
    {
        ...
        return (midgameEval * phase + endgameEval * (24 - phase)) * (board.IsWhiteToMove ? 1 : -1);
    }
